 ...
 */
export function bandwidth<N extends NodeLike, L extends LinkLike<N>>(graph: Graph<N, L>, order: number[]): number {
 ...
 * @returns {integer} the bandwidth
 */
export function bandwidth_matrix(matrix: number[][]): number {
    let max = 0;
